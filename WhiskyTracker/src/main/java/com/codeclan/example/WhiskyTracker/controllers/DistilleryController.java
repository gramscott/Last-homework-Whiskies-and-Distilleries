...
public class DistilleryController {
    ...
    public ResponseEntity <List<Distillery>> findByDistilleryByRegion(@RequestParam(name = "region") String region){
        if(region != null ){
...
//    public ResponseEntity <List<Distillery>> findWhiskyByYearFromDistillery(@RequestParam(name="year") int year ){
